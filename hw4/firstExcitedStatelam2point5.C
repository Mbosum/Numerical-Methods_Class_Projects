/*
This program determines the first excited state energy and plots the first excited state wavefunction for the case lambda = 2.5 
...
#include <fstream>
ofstream prtwave("firstExcitedStatelam2point5.dat");
...
int main() {
	...
	if(slope==1){			        //Odd function condition (psi prime = 1)
