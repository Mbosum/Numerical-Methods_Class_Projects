/*:
This program determines the Second Excited state energy and plots the second excited state wavefunction for the case lambda =0.0 
...
#include <fstream>
ofstream prtwave("secondExcitedStatelam0.dat");
...
int main() {
	...
	Ebottom = 1.7;     //above first excited state energy eigenvalue                       
	Etop = 4.9;
