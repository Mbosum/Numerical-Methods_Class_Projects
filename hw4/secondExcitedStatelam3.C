/*:
This program determines the Second Excited state energy and plots the second excited state wavefunction for the case lambda =3.0 
...
#include <fstream>
ofstream prtwave("secondExcitedStatelam3.dat");
