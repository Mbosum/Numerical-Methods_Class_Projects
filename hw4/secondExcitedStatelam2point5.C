/*:
This program determines the Second Excited state energy and plots the second excited state wavefunction for the case lambda =2.5 
...
#include <fstream>
ofstream prtwave("secondExcitedStatelam2point5.dat");

const double slope = 0;
const double lamda = 2.5;
...
int main() {
	...
	Ebottom = 1.1;     //above first excited state energy eigenvalue                       
	Etop = 2.9;
