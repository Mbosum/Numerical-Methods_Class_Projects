/*
This program determines the first excited state energy and plots the first excited state wavefunction for the case lambda = 3.0 
...
#include <fstream>
ofstream prtwave("firstExcitedStatelam3.dat");

const double slope = 0;
const double lamda = 3.0;
