/*
This program determines the first excited state energy and plots the first excited state wavefunction for the case lambda =1.0 
...
#include <fstream>
ofstream prtwave("firstExcitedStatelam1.dat");
