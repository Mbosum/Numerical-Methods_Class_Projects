/*
This program determines the ground state energy and plots the ground state wavefunction for the case lambda = 2.5 
...
#include <fstream>
ofstream prtwave("groundStatelam2point5.dat");
